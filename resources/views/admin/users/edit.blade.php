                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-control row">
                                <input type="radio" id="user_type" name="user_type" class="admin" @if($model->user_type == 'admin') checked @else @endif required
                                       value="admin"> {{trans('admin.admin')}}
                                <input type="radio" id="user_type" name="user_type" class="client" @if($model->user_type == 'client') checked @else @endif style="@if(direction() == 'ltr') margin-left: 30px; @else margin-right: 30px; @endif" required
                                       value="client"> {{trans('admin.client')}}
                                <input type="radio" id="user_type" name="user_type" class="representative" @if($model->user_type == 'representative') checked @else @endif style="@if(direction() == 'ltr') margin-left: 30px; @else margin-right: 30px; @endif" required
